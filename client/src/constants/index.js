export const surpriseMePrompts = [
  ...
  'A bicycle that is also a boat',
  'A chair that transforms into a bed',
  'A building that looks like a giant tree',
  'A car that can fly',
  'A robot that can cook a meal',
  'An animal with the head of a horse and the body of a snake',
  'A city floating in the clouds',
  'A musical instrument made from flowers',
  'A castle made of ice',
  'A shoe that can turn into a boat',
  'A modern office chair with built-in adjustable lighting',
  'A sleek and compact modular sofa for small apartments',
  'A sustainable and eco-friendly house made from recycled materials',
  'A hybrid electric car with a solar roof',
  'A minimalist and functional kitchen island with built-in storage',
  'A smart security camera that also acts as a birdhouse',
  'A stylish and practical backpack with a built-in hydration system',
  'A contemporary and energy-efficient light fixture for a living room',
  'A portable and collapsible picnic table with a built-in cooler',
  'A versatile and foldable work desk with a built-in lamp',
];
